...
from coscientist.models import approval, approach, critic, device, evidence, execution, experiment, feedback, governance, hypothesis, ontology, roadmap, score, synthesis, validation  # noqa: F401 — ensure tables created

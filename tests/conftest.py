...
from coscientist.models import approval, approach, device, evidence, experiment, feedback, governance, hypothesis, ontology, roadmap, score, validation  # noqa: F401 — ensure tables created
